...
nts.dashboards.chart_sources["Hiring vs Attrition Count"] = {
	...
	filters: [
		...
		},
		{
			...
			label: __("From Date"),
			fieldtype: "Date",
			default: nts.defaults.get_user_default("year_start_date"),
			reqd: 1,
		},
		{
			fieldname: "to_date",
			label: __("To Date"),
			fieldtype: "Date",
			default: nts.defaults.get_user_default("year_end_date"),
		},
		{
